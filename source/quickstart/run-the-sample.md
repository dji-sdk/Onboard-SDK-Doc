...
After registering the account, please download the [sample](https://github.com/dji-sdk/Onboard-SDK) and supplement the application information, after compiling, debugging and burning, developer could run the application, With the help of those samples, developer would know how to develop the application.

> **NOTE** DJI's sample are developed on Manfold 2 and STM3241G-EVAL using Linux and FreeRTOS. If you need to port the sample code to other operating systems or hardware platforms, please refer to [Porting](../quickstart/porting.html).
...
#### Execute the sample program
   ...
   * Select the Flash-Download option to **burn** the compiled program to the third-party development platform (such as STM32F407IGH6-EVAL).
...
* Activate troubleshooting
   * Please refer to [Device Connection](./device-connection.html) and connect the drone, the third-party development platform; please confirm that the voltage of the UART line is 3.3V.
