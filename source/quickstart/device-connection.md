...
Figure 1 display the process of connection, that connected onboard computer and DJI's drone.
...
M210 V2 series drones include M210 V2 and M210 RTK V2. For details, please refer to [User's Manual](https://dl.djicdn.com/downloads/m200_v2/20191213/M200_V2_UM_EN_v1.2_2.pdf).
...
#### Access to onboard computer Manifold 2
...
* Connect the USB cable: Manifold 2 communicates with the drone through **dual-head USB cable**.
...
* When using an external power supply to power Manifold 2:
...
> **NOTE** If developers want to use Matrice 210 RTK for time synchronization, please use a cable to connect the SYNC Line interface on Manifold 2 to the PPS and GND pins on the rear of the drone.

#### Access to third-party development platforms
According to the situation of the third-party platform, connect the M210 V2 series to the third-party development platform:
* Connect the USB cable: Communicate with the drone through the **dual USB cable**.
* Connect the serial cable:
     * Method 1: Connect the expansion interface at the tail of the drone to the UART1 interface of the third-party development platform using a serial cable;
     * Method 2: Use a USB-to-serial cable to connect the expansion interface at the rear of the aircraft to the USB interface of a third-party development platform.
* When using an external power supply to power a third-party development platform, please ensure that it does not interfere with the normal operation of the drone.

> **NOTE** Do not use the VCC pin to power the third-party development platform in violation of regulations, otherwise the drone or the third-party development platform may be damaged.

## Using M300 RTK drone

> **NOTE**
> * When installing Manifold 2 or a third-party development platform on the Matrice 300 RTK drone, please use the OSDK adapter board.
> * When using a third-party platform as an onboard computer, please avoid generating magnetic fields that interfere with the normal operation of the drone.

In order to facilitate developers to fix the onboard computer Manifold 2 or a third-party computing platform on the M300 RTK drone, DJI provides an onboard computer adapter board, which provides the XT30 24V power supply interface, OSDK serial port and OSDK USB 2.0 interface, developers can design the onboard computer adapter board according to the structure and interface of the adapter board. To avoid accidents such as burning the adapter board or onboard computer due to improper use, please read the following carefully before using the adapter board.
...
* OSDK onboard computer communication interface
<div>
<div style="text-align: center"> <p> Figure 3. OSDK onboard computer communication interface </p>
</div>
<div>
<div style="text-align: center"> <p> <span>
...
> * When using a serial cable connect the onboard computer and the onboard computer adapter board, the definition of the adapter board interface is the same as the definition of the interface of the M210 series;
> * Developers can use the power cord and USB cable to connect the onboard computer and the onboard computer adapter board.


* OSDK USB2.0 interface Device
<div>
<div style="text-align: center"> <p> Figure 4. OSDK USB2.0 interface (Device)</p>
</div>
<div>
<div style="text-align: center"> <p> <span>
...
* External power supply 24V (XT30)
<div>
<div style="text-align: center"> <p> Figure 5. External power supply 24V (XT30) </p>
</div>
<div>
<div style="text-align: center"> <p> <span>
...
* Data communication interface
    ...
    * To use the serial port on the drone to communicate between the onboard computer and the drone, please use the UART_RX and UART_TX pins
        * UART_RX: This pin is the pin that receives the drone output signal **through the connecting line** of the onboard computer adapter board, this pin corresponds to the signal output pin TX of the drone OSDK expansion interface
      * UART_TX: This pin is the pin for sending signals to the drone via the connecting cable ** of the onboard computer adapter board, corresponding to the signal receiving pin RX of the extended interface of the drone OSDK
* Application function interface
     * If you need to use the synchronization signal output by the drone to achieve the time synchronization function, please use the SYNC (PPS) pin
     * Using an onboard computer, **must** use the ON_DET pin, and the opposite connected to the ON_DET pin **must** is **GND**
